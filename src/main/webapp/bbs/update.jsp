  ...
  <div id="main">
   <%
      ...
      if(mId==null){
         ...
         script.println("location.href='/termproject/login/login.jsp");
         script.println("</script>");
      }
      int bId=0;
...
<div class="container">
         ...
         <table class="table table-striped" style="text-align: center; border:1px solid #dddddd">
               <thead>
                  <tr>
                     <th colspan="2" style="background-color:#eeeeee; text-align:left;">게시판 글 수정</th>
                  </tr>
               </thead>
               <tbody>
                  <tr>
                     <td><input type="text" class="form-control" placeholder="글 제목" name="bTitle" maxlength="50" value="<%=bbs.getbTitle()%>"></td>
                  </tr>
                  <tr>
                     <td><textarea class="form-control" placeholder="글 내용" name="bContent" maxlength="2048" style="height=350px;"><%=bbs.getbContent()%></textarea></td>
                  </tr>
               </tbody>   
            </table>   
